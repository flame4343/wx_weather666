...
class Wechat extends Controller
{
    ...
    function getToken(){
        return $this->checkAccessToken("wxd33dafa3e4d1a80c","5051afe8fa11c7e999e30b9e33257df7");
    }
  ...
  public function createmenu(){
      $data='{
       "button":[
       {
            "type":"view",
            "name":"天气查询",
			"url":"http://140.143.165.86/wx/weather.html"
        },
        {
             "name":"头号邦吹",
             "sub_button":[
  ...
  public function getuser(){
         ...
         var_dump($user_info);
             echo'<img src='.$user_info["headimgurl"].' />';
  }
